<template>
  <div class="content-container">
    <h3>普通 button 样式</h3>
    <div>
      <a href="https://dev.to/gscode/20-css-buttons-4cni" style="margin-right: 20px;">好看的button链接1</a>
    ...
    <a class="btn-hover btn-hover3" ref="hover3" @mouseenter="hoverEnterLeave"
         @mouseleave="hoverEnterLeave"
    >btnhover3<span ref="hoverSpan" :style="{left,top}"></span></a>
  </div>
</template>
...
.btn-hover1 {
  ...
  &:before {
    ...
    transform: translateX(-100%); // 伪元素初始位置，由于父元素overflow：hidden 所有看不见
