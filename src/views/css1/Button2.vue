...
.button {
    ...
    div {
        ...
        span {
            ...
            animation: var(--name, none) 0.7s linear forwards 18s;
        }
    }
...
@keyframes move {
    30%,
    36% {
        transform: translateY(calc(-12px * var(--move))) translateZ(0)
    ...
    70% {
        transform: translateY(calc(-4px * var(--move))) translateZ(0)
