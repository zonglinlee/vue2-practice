<template>
    <div
        ...
        style="padding: 0; margin-left: 0; overflow: hidden"
    >
        <h3>以下domo需要再手机模拟样式下查看</h3>
        <h4>纯滚动,无scroll-snap效果</h4>
        <div class="list">
            <button class="button" data-type="danger">删除</button>
            <a class="content" href="javascript:">我是列表，试试左滑我</a>
            <s class="space"></s>
        </div>
        <h4>多个按钮定位视差滚动，开启scroll-snap效果</h4>
